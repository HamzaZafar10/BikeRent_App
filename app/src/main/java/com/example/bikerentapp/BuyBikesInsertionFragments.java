...
public class BuyBikesInsertionFragments extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_buy_bikes_insertion_fragments, container, false);
        ...
        Insert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                } else if (Des.isEmpty() || Sale.isEmpty() || Name.isEmpty()||Model.isEmpty()) {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Task<Uri> downloadUrl = taskSnapshot.getStorage().getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    SaleBickeModel model = new SaleBickeModel(Model,sale_price,Des,Name,task.getResult().toString());
                                    obj.addBike(model).addOnSuccessListener(suc -> {
